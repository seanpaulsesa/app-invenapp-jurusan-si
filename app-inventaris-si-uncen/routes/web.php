...
Route::middleware([
    ...
    Route::prefix('kategori-barang')->group(function () {
        ...
        Route::get('/tambah', [KategoriBarangController::class, 'tambah'])->name('kategori-barang.tambah');
    ...
    Route::prefix('ruangan')->group(function () {
        ...
        Route::get('/tambah', [RuanganController::class, 'tambah'])->name('ruangan.tambah');
    ...
    Route::prefix('kategori-ruangan')->group(function () {
        ...
        Route::get('/tambah', [KategoriRuanganController::class, 'tambah'])->name('kategori-ruangan.tambah');
