                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('kategori-ruangan') }}" class="btn btn-primary btn-sm mb-3">Kembali</a>
                        </div>
                        <div class="card-body">
                            
                        
                        <form action="{{ isset($data) ? route('kategori-ruangan.update', $data->id) : route('kategori-ruangan.store') }}" method="POST"  enctype="multipart/form-data">
                            @csrf
                            @if(isset($data))
                                @method('PUT')
                            @endif
                            ...
                            <!-- Nama Ruangan -->
                            <div class="mb-3">
                                <label for="nama_kategori" class="form-label">Nama Kategori Ruangan</label>
